...
C.MODEL.FEATURE_EXTRACTOR.HAS_CACHE = False
C.MODEL.FEATURE_EXTRACTOR.FROM_FEATURE_DIM = 0
C.MODEL.FEATURE_EXTRACTOR.HAS_RELATIONS = False
C.MODEL.FEATURE_EXTRACTOR.IS_PRETRAINED = True
C.MODEL.FEATURE_EXTRACTOR.FREEZE = False
...
C.SOLVER.COOLDOWN_FACTOR = .1
C.SOLVER.COOLDOWN_ROUND = 25

C.SOLVER.VALIDATION_PERIOD = 1000
C.SOLVER.VALIDATION_ROUND = 8
C.SOLVER.CHECKPOINT_PERIOD = 1000
C.SOLVER.CHECKPOINT_ROUND = 8
C.SOLVER.VALIDATION_LIMIT = 100
C.SOLVER.PATIENCE = 5
C.SOLVER.MAX_ROUND = 100
